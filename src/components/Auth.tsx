                    ...
                    {mode !== 'forgot_password' && (
                        <>
                            <button
                                ...
                                className={cn(
                                    "w-full py-3 px-4 rounded-xl flex items-center justify-center gap-3 font-semibold transition-all duration-300 border",
                                    googleLoading
                                        ? "bg-white/5 border-white/10 text-white/50 cursor-not-allowed"
                                        : "bg-white/[0.07] border-white/10 text-white hover:bg-white/[0.12] hover:border-white/20 active:scale-[0.98]"
                                )}
                            >
                                {googleLoading ? (
                            ...
                            <div className="relative my-6">
                                ...
                                <div className="relative flex justify-center text-xs">
                                    <span className="bg-[#0d0d0d] px-3 text-gray-500 uppercase tracking-wider">or</span>
                                </div>
                            </div>
                        </>
                    )}
